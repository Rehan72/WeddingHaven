        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/search-halls" className="text-muted-foreground hover:text-foreground">
                  Search Halls
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/list-your-hall" className="text-muted-foreground hover:text-foreground">
                  List Your Hall
                </Link>
              </li>
              <li>
